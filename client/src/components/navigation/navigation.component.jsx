        ...
        <div className="bg-black-80">
          <nav className="dt mw8 w-100 center">
            ...
            <div className="dtc v-mid tr pa3">
              ...
              />
              <Link
                className="f4 fw4 hover-white no-underline white dn dib-ns pv2 ph3"
                to="/shop"
              >
                Shop
              </Link>
              <Link
                className="f4 fw4 hover-white no-underline white dn dib-l pv2 ph3"
                to="/contact"
              >
                Contact
              </Link>
              <Link
                className="f4 fw4 hover-white no-underline white dib ml2 pv2 ph3 ba"
                to="/signin"
              >
                Sign In
              </Link>
